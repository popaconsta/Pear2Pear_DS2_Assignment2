@ECHO OFF
TITLE Pear2Pear_DS2_Assignment2
...
CD Pear2Pear_DS2_Assignment2

REM Start the Model
START javaw -XX:+IgnoreUnrecognizedVMOptions --add-modules=ALL-SYSTEM --add-exports=java.base/jdk.internal.ref=ALL-UNNAMED -cp %CP% repast.simphony.runtime.RepastMain ./Pear2Pear_DS2_Assignment2.rs
